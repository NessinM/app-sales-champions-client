  ...
  v-col(cols="12", lg="3", md="6", sm="12")
    .flex.align-center.justify-center
      v-text-field(
        ...
        variant="solo",
        clearable,
        placeholder="Buscar por razón social, id",
        type="text",
        hide-details,
        @input="filterData"
      )
    ...
    perfect-scrollbar.overflow-y-auto.pb-5(class="h-[calc(100vh-170px)]")
      ...
      v-list.py-0(mandatory, color="primary")
        v-list-item.py-2(
          ...
          v-list-item-title
            span.font-extrabold.uppercase.text-xs {{ i.asunto }}
          v-list-item-subtitle
            span.text-xs {{ i.cliente.razon_social }}
          template(#append)
    ...
    const getAllEvents = async () => {
      try {
        ...
        /* eslint-disable */ console.log(
          ...oo_oo(`13ebc2ac_0`, "response", response)
        );
