        ...
        try {
          ...
          if (response.event.length) {
            ...
            /* eslint-disable */ console.log(
              ...oo_oo(`3eafc78e_0`, "getEventsss", getEvent)
            );
