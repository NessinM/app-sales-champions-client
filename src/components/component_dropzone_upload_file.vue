<template lang="pug">
.flex
  v-card.flex.items-center.justify-center.w-full.dropzone.h-54.pa-4(
    ...
    .flex.flex-col.items-center.justify-center.w-full.border-2.border-dashed.rounded-lg.cursor-pointer.pa-4(
  ...
  .flex.ml-4(v-if="state.files.length")
    .relative.h-54.w-32.mx-2(
